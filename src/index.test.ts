...
describe("socketcand", () => {
    describe("Performance Tests", () => {
        it("should pass if ", () => {
            ...
            console.log("Old Frames/sec: " + (((endTime - startTime) / bigIntItems) * BigInt(1000000000)).toLocaleString())
            console.log("New Throughput: " + ((newEndTime - newStartTime) / bigIntItems) + " frames/ns")
            console.log("New Frames/sec: " + (((newEndTime - newStartTime) / bigIntItems) * BigInt(1000000000)).toLocaleString())
